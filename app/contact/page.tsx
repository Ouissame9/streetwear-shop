...
export default function Contact() {
  return (
    <main style={{minHeight: "100vh", background: "black", color: "white", overflowX: "hidden"}}>
      ...
      {/* NAVBAR */}
      <nav style={{display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 16px", borderBottom: "1px solid rgba(255,255,255,0.1)", position: "sticky", top: 0, zIndex: 50, background: "rgba(0,0,0,0.92)", backdropFilter: "blur(10px)", boxSizing: "border-box", width: "100%"}}>
      ...
      <section style={{padding: "50px 16px 32px", textAlign: "center", position: "relative", overflow: "hidden"}}>
        ...
        <div style={{position: "relative", zIndex: 10}}>
          ...
          <p style={{color: "rgba(255,255,255,0.4)", fontSize: "14px", maxWidth: "500px", margin: "0 auto"}}>
            Une question sur un produit ? On te répond rapidement.
          </p>
        </div>
      </section>
      ...
      <section style={{maxWidth: "600px", margin: "0 auto", padding: "0 16px 40px"}}>
        <div style={{border: "1px solid rgba(74,222,128,0.3)", borderRadius: "24px", padding: "28px", background: "rgba(74,222,128,0.04)", marginBottom: "24px", textAlign: "center"}}>
          ...
          {/* Avatar */}
          <div style={{width: "80px", height: "80px", borderRadius: "50%", background: "linear-gradient(135deg, #4ade80, #7e22ce)", margin: "0 auto 16px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "32px", fontWeight: 900, color: "black"}}>
            O
          </div>
